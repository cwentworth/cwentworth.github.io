...
pp = csFinal.plot.area(style={'Chris':'Red','Dennis':'Teal','Matt':'Blue'},stacked=False)
...
for index,item in enumerate(meechPoolPicks["week_11"]):
    if index + 1 == len(meechPoolPicks["week_11"]):
        print(item[0],"-",item[1])
    else:
        print(item[0])